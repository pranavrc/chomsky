...
import textwrap, random, os, sys
from itertools import chain, islice, izip

class Chomsky:
    def __init__(self, times=1, line_length=os.popen('stty size', 'r').read().split()[1]):
        self.leadins = """To characterize a linguistic level L,
            On the other hand,
            This suggests that
            It appears that
            Furthermore,
        ...
        self.subjects = """ the notion of level of grammaticalness
        ...
        self.verbs = """can be defined in such a way as to impose
            delimits
        ...
        self.objects = """ problems of phonemic and morphological analysis.
        ...
        self.output_text = textwrap.fill(' '.join(output), int(line_length))
